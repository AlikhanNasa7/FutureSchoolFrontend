...
interface ImportTeachersExcelModalProps {
    isOpen: boolean;
    onClose: () => void;
    onImportComplete?: () => void;
}

export default function ImportTeachersExcelModal({
    isOpen,
    onClose,
    onImportComplete,
}: ImportTeachersExcelModalProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const errorMessage =
                ...
                'Не удалось импортировать учителей. Проверьте формат файла.';
                ...
                <form onSubmit={handleSubmit} className="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <p className="mt-2 text-xs text-gray-500">
                            Обязательные колонки: <span className="font-mono">first_name</span>,{' '}
                        ...
                        <div className="bg-green-50 border border-green-200 rounded-lg p-4 space-y-4">
                            ...
                            <div className="space-y-2 text-sm">
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <p className="text-gray-600">Учителей создано:</p>
                                        <p className="font-semibold text-gray-900">
                                            {result.summary.total_teachers}
                                        </p>
                                    </div>
                                    <div>
                                ...
                                {result.default_password && (
                                    <div className="bg-white border border-green-300 rounded p-3 mt-3">
                                        <p className="text-xs text-gray-600 mb-1">
                                            Пароль для всех созданных учителей:
                                        </p>
